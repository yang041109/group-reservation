...
export default function MenuSection({
  ...
  return (
    <section className="mt-6 space-y-4">
      <h2 className="text-2xl font-extrabold tracking-tight text-gray-800">🍽️ 메뉴 선택</h2>
          ...
          {ownerNoticeText ? (
            <div className="rounded-3xl border border-gray-200 bg-gray-50 p-4">
              <div className="flex items-start gap-3">
                <span className="inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-orange-400 text-[13px]">
                  📢
                </span>
                <div className="min-w-0">
                  <p className="text-[13px] font-bold text-orange-500">가게 안내</p>
                  <p className="mt-1 whitespace-pre-line text-[13px] leading-relaxed text-gray-900">
